...
export default function About() {
  return (
    <section className="bg-white py-20">
      <div className="w-[332px] rounded-xl bg-white flex flex-col items-center mx-auto py-10  shadow-2xl shadow-teal-200 lg:w-[80%]">
        <h1 className="text-[30px] font-semibold lg:text-[80px]">About Me</h1>
        <p className="text-[14px] w-[282px] mt-5 font-semibold text-center lg:text-[20px] lg:w-[500px]">
          I am a front-end developer based in Nigeria. Has Mechanical
          Engineering background.
        </p>
        <p className="text-center text-[14px] w-[260px] mt-5">
        ...
        <div className="flex flex-col items-center gap-5 text-[14px]">
          <h1 className="text-[24px] font-semibold mt-10">My Skills</h1>
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-[24px] font-semibold mt-10">My Experience</h1>
          <p className="text-center text-[14px] w-[260px] mt-5">
            I am a front-end developer based in Sydney looking for exciting
            opportunities. Has Mechanical Engineering background. Likes to focus
