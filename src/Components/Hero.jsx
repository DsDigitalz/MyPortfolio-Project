...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] pt-45 lg:pt-50 pb-20 px-4 flex flex-col items-center lg:flex-row-reverse lg:justify-between lg:gap-7 lg:px-40">
        <motion.img
          src="danny.png"
          alt=""
          className="mx-auto shadow-2xl  w-2/4 md:w-1/2 lg:w-[40%] xl:w-[30%] lg:mx-0"
