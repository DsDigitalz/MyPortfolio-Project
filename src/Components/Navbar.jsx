...
export default function Navbar() {
  return (
    <section>
      <div className="lg:flex justify-between px-10 scroll-smooth">
        <div className="flex justify-between px-5 py-3 items-center">
          ...
          <div className="flex flex-col gap-1 justify-center relative lg:hidden">
        ...
        <div className="flex justify-between items-center p-5">
          <ul className="hidden lg:flex gap-[55px] text-[16px] font-medium pr-20">
